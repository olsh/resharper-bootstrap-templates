---
guid: 589e6938-b5e5-4eb2-91e9-f4c54bd428d8
type: Live
reformat: True
...
parameterOrder: id
id-expression: constant("carousel-id")
---
...
<div id="$id$" class="carousel slide" data-ride="carousel">
    <ol class="carousel-indicators">
        <li data-target="#$id$" data-slide-to="0" class=""></li>
        <li data-target="#$id$" data-slide-to="1" class=""></li>
        <li data-target="#$id$" data-slide-to="2" class="active"></li>
    </ol>
