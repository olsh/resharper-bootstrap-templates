...
namespace Resharper.Bootstrap4.Templates.CodeCompetition
{
    [SolutionComponent]
    public class Bootstrap4CompletionStrategy : IAutomaticCodeCompletionStrategy
    {
        private readonly SettingsScalarEntry _settingsScalarEntry;

        public Bootstrap4CompletionStrategy(ISettingsStore settingsStore)
        {
